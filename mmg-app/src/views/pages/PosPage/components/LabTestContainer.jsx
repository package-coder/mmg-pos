...
const LabTestContainer = ({ items, regDiscount, onRemoveItem, regDiscountType  }) => {
                        ...
                        <React.Fragment key={index}>
                            ...
                            {item.labTest ? (
                                ...
                                >
                                    ...
                                    <TableCell>
                                        <FaPesoSign style={{ marginLeft: '3px', fontSize: '0.85rem' }} />{' '}
                                        {regDiscount && regDiscountType === 'percentage' ? new Intl.NumberFormat().format(item.amount * (regDiscount / 100)) : 0}
                                    </TableCell>
                                    <TableCell>
                                        <FaPesoSign style={{ marginLeft: '3px', fontSize: '0.85rem' }} />{' '}
                                        {new Intl.NumberFormat().format(
                                            regDiscountType === 'percentage'
                                            ? item.amount - item.amount * (regDiscount / 100)
                                            : item.amount
                                        )}
                                    </TableCell>
                                    <TableCell>
