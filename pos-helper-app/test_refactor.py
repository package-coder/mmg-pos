...
ptz.timezone = lambda x: None
sys.modules["pytz"] = ptz

# Mock serial
ser = types.ModuleType("serial")
ser.Serial = type("Serial", (), {"write": lambda self, x: None})
sys.modules["serial"] = ser

# Mock websockets
ws = types.ModuleType("websockets.asyncio.server")
ws.serve = lambda *args, **kwargs: None
...
# Override get_local_time to avoid pytz
app.get_local_time = lambda: datetime.datetime.now()
